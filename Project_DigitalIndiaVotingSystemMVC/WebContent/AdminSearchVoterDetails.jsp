...
<h2>Search Voter Details By Voter ID</h2>
<form action="">
<center>
<input type="text" name="VoterIDByAdmin" autofocus placeholder=" Please Enter Voter ID" size="25px"/>
...
try
{
String voterid=request.getParameter("VoterIDByAdmin");
...
<center>
<br>
<h3>The Voter Details Are Given Below</h3>
<br>
<br>
